...
export const ADOPTION_SCHEMAS: CollectionAdoptionSpec[] = [
  ...
  },
  {
    ...
    identity: { kind: 'composite', fields: ['sourceChapterId', 'subjectName', 'predicate', 'value', 'sourceQuote'] },
    duplicatePolicy: 'skip',
    required: ['subjectName', 'predicate', 'factKind', 'value', 'sourceType', 'status', 'locked'],
    autoStamps: ['projectId', 'worldGroupId', 'createdAt', 'updatedAt'],
    fkChecks: [
      { field: 'characterId', target: 'characters' },
      { field: 'locationId', target: 'importantLocations' },
      { field: 'storyArcId', target: 'storyArcs' },
      { field: 'subjectWorldGroupId', target: 'worldGroups' },
      { field: 'codexEntryId', target: 'codexEntries' },
      { field: 'objectCharacterId', target: 'characters' },
      { field: 'objectLocationId', target: 'importantLocations' },
      { field: 'objectCodexEntryId', target: 'codexEntries' },
      { field: 'sourceChapterId', target: 'chapters' },
      { field: 'validFromChapterId', target: 'chapters' },
      { field: 'validToChapterId', target: 'chapters' },
      { field: 'supersedesFactId', target: 'temporalFacts' },
    ],
  },
  {
