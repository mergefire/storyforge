            ...
            >
              ...
              {(editing === c.id) ? (
                <div className="mt-2 space-y-1.5">
                  <CharacterDimensionFields character={c} onChange={patch => update(c.id!, patch)} exclude={['shortDescription']} projectId={project.id!} worldGroupId={c.homeWorldGroupId ?? null} />
                  <button
