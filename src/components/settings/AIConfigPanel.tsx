    ...
    <div className="max-w-2xl">
      ...
      <div className="bg-bg-surface border border-border rounded-xl p-5 mb-6">
        ...
        <AIConfigPresetSection
          ...
          onApplyPreset={id => runSettingsChange(flushApiKeyDraft().then(() => applyPreset(id)))}
          onUpdatePreset={id => runSettingsChange(flushApiKeyDraft().then(() => updatePresetFromCurrent(id)))}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                runSettingsChange(flushApiKeyDraft().then(() => switchProvider(provider)))
              }}
