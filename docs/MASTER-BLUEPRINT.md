...
5. 本专项当前状态为 **D0 进行中**。D0.1 已由 Codex 交付并于 2026-07-14 通过 Claude 独立治理审查；D0.2 已冻结作者自用本机自签名边界，仍待本次决议提交与独立审查，D0.3～D0.4 进行中；D0.5～D5.5、G1、G2 均未完成，不得表述为“客户端已可用”或“已通过桌面验证”。
